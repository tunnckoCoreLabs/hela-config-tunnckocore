...
_You might also be interested in [parse-function][highlighted-link] or in the other [related projects](#related-projects)._
...
If you have any _how-to_ kind of questions, please read [Code of Conduct](./CODE_OF_CONDUCT.md) and **ping me on [twitter][]** or [open an issue][open-issue-url].  
...
- [p-map](https://www.npmjs.com/package/p-map): Map over promises concurrently | [homepage](https://github.com/sindresorhus/p-map#readme "Map over promises concurrently")
...
[highlighted-link]: https://ghub.now.sh/parse-function
