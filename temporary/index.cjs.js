...
const rollup = _interopDefault(require('rollup'));
const rollupPluginCommonjs = _interopDefault(require('rollup-plugin-commonjs'));
const pify = _interopDefault(require('pify'));
const pMap = _interopDefault(require('p-map'));
const timeStamp = _interopDefault(require('time-stamp'));
const isobject = _interopDefault(require('isobject'));
const pIsPromise = _interopDefault(require('p-is-promise'));
const prettyConfig = _interopDefault(require('@tunnckocore/pretty-config'));
const builtinModules = _interopDefault(require('builtin-modules'));
const isCi = _interopDefault(require('is-ci'));
